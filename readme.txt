...
Publish sermons from kerktijden.nl

== Description ==

Publish sermons from [kerktijden.nl](http://www.kerktijden.nl/). 
[kerktijden.nl](http://www.kerktijden.nl/) will make their own plugin. Until then this plugin will help you to show the sermons.
...
1. Look foor the URL and search the id of you church
	a. example a: http://www.kerktijden.nl/?zoek=kerken&kerkid=1 = id 1
	a. example b: http://www.kerktijden.nl/?zoek=kerken&kerkid=345 = id 345
...
1. Overview on the front side. Table of sermons as is.
